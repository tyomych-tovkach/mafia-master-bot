...
import static ru.tayviscon.mafia.master.bot.domain.query.filter.AdvancedFieldFilter.in;
...
public class UnregisterGameSessionTelegramBotCallbackHandler implements TelegramBotCallbackHandler {

    private static final String NAME = "unreg-in-game";
    ...
    public void handle(Update update, TelegramLongPollingBot telegramBot) {
        ...
        participantFilter.setParticipantStatus(in(List.of(MafiaGameSessionParticipantStatus.REGISTERED, MafiaGameSessionParticipantStatus.CONFIRMED)));
        ...
        if (participantsInfo.isEmpty()) {
            ...
            mafiaGameSessionParticipant.setStatus(MafiaGameSessionParticipantStatus.CANCELLED);
        ...
        sendMessage.setText("Мы отменили вашу запись на игру!(");
